...
<div class="container">
    <div class="account">
        ...
        <form action="#" method="post" id="buyForm">
            ...
            <div>
                <span>购买数量</span>
                <input type="text" value="${orderAndCommodity.orderDetail.count}" name="count">(可修改)
            </div>
            <div>
                <span>商品单价</span>
            ...
            <div>
                ...
                <select name="size">
                    <option value="L"
                            <c:if test="${orderAndCommodity.orderDetail.size.equals('L')}">
                                selected = "selected"
                            </c:if>
                    >L
                    </option>
                    <option value="M"
                            <c:if test="${orderAndCommodity.orderDetail.size.equals('M')}">
                                selected = "selected"
                            </c:if>
                    >M
                    </option>
                    <option value="S"
                            <c:if test="${orderAndCommodity.orderDetail.size.equals('S')}">
                                selected = "selected"
                            </c:if>
                    >S
                    </option>
                    <option value="XL"
                            <c:if test="${orderAndCommodity.orderDetail.size.equals('XL')}">
                                selected = "selected"
                            </c:if>
                    >XL
                    </option>
                    <option value="XXL"
                            <c:if test="${orderAndCommodity.orderDetail.size.equals('XXL')}">
                                selected = "selected"
                            </c:if>
                    >XXL
                    </option>
            ...
            <div>
                <span>商品描述　${orderAndCommodity.commodity.detail}</span>
            </div>
            <div>
                <span>商品类型</span>
